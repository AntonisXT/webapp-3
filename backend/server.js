...
app.use(cors({ origin: FRONTEND_ORIGIN ? [FRONTEND_ORIGIN] : false, credentials: true, methods: ['GET','POST','PUT','PATCH','DELETE'], allowedHeaders: ['Content-Type','Authorization'] }));
